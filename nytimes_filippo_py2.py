...
class NYTimesSource(object):
    ...
    def getDataBatch(self, batch_size=10, max_pages=100, page=None, wait_code429=False):
        """
...
if __name__ == '__main__':
    ...
    for idx, batch in enumerate(source.getDataBatch(batch_size, max_pages=args.max_pages, wait_code429=args.wait_code429)):
        print("{0} Batch of {1} items".format(idx, len(batch)))
        for item in batch:
            print(u"\t- {0} - {1}".format(item['_id'], item['headline.main']).encode('utf-8'))
